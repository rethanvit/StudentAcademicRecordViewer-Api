...
namespace SRV.DL.Migrations
{
    ...
    [Migration("20230929125216_AddUserStudentManyToManyReleationshipTable")]
    partial class AddUserStudentManyToManyReleationshipTable
    {
            ...
            modelBuilder.Entity("SRV.DL.AcademicCalendar", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            AcademicCalendarId = 7,
                            AcademicTermId = 4,
                            Name = "Fall"
                        },
                        new
                        {
                            AcademicCalendarId = 8,
                            AcademicTermId = 4,
                            Name = "Winter"
                        },
                        new
                        {
                            AcademicCalendarId = 9,
                            AcademicTermId = 4,
                            Name = "Spring"
                        },
                        new
            ...
            modelBuilder.Entity("SRV.DL.Department", b =>
                {
                    ...
                    b.HasAlternateKey("Code", "Name", "OrganizationId");
            ...
            modelBuilder.Entity("SRV.DL.Program", b =>
                {
                    ...
                    b.HasAlternateKey("Code", "Name", "DepartmentId");
